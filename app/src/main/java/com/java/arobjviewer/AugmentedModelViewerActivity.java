...
import com.java.ar.exceptions.ARException;
import com.java.arobjviewer.graphics.LightingRenderer;
import com.java.arobjviewer.graphics.Model3D;
import com.java.arobjviewer.models.Model;
import com.java.arobjviewer.parser.ObjParser;
import com.java.arobjviewer.parser.ParseException;
import com.java.arobjviewer.util.AssetsFileUtil;
import com.java.arobjviewer.util.BaseFileUtil;

import edu.dhbw.andar.ARActivity;
...
public class AugmentedModelViewerActivity extends ARActivity implements SurfaceHolder.Callback {
...
//						Debug.stopMethodTracing();
    	...
    	protected void onPostExecute(Void result) {
			...
			System.out.println("wait dilogue closed");
			waitDialog.dismiss();
