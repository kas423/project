 ...
 *
 */
public class ARObjectRenderer implements Renderer{
	...
	private LightingRenderer customRenderer;
	 ...
	 */
	public ARObjectRenderer(Resources res, ARToolkit markerInfo, ARActivity activity)  {
		this.res = res;
