...
import edu.dhbw.andar.CameraPreviewHandler.AutoFocusHandler;
...
public class ARToolkit {
	...
	private List<AutoFocusHandler> visListeners = new ArrayList<AutoFocusHandler>();
	 ...
	 */
	@Deprecated
	public void setVisListener(AutoFocusHandler visListener) {		
		this.visListeners.add(visListener);
	}
	
	public void addVisibilityListener(
			AutoFocusHandler markerVisibilityListener) {
	...
	class DetectMarkerWorker extends Thread {
		...
		private void notifyChange(boolean visible) {
			for (final AutoFocusHandler visListener : visListeners) {
