...
public class CameraPreviewHandler implements PreviewCallback {
	...
	private ARObjectRenderer frameSink;
	...
	public CameraPreviewHandler(GLSurfaceView glSurfaceView,
			ARObjectRenderer sink, Resources res, ARToolkit markerInfo, CameraStatus camStatus) {
	...
	class ConversionWorker extends Thread {
		 ...
		 * 
		 */
		public ConversionWorker(ARObjectRenderer frameSink) {
			setDaemon(true);
